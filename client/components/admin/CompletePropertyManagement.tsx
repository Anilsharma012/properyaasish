            ...
            <TableBody>
              {properties.map((property) => {
                ...
                <TableRow key={property._id || property.id}>
                  <TableCell className="font-medium">
                    <div className="flex items-start space-x-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-500">{property.propertyType} • {property.subCategory}</p>
                  ...
                  <TableCell>
                    <div>
                      <p className="font-medium">{property.ownerName || property.contactInfo.name}</p>
                      <p className="text-sm text-gray-500 flex items-center">
                  ...
                  <TableCell>
                    <div className="space-y-1">
                      ...
                      <div className="flex items-center space-x-1">
                        ...
                        <span className="text-sm">{property.inquiries} inquiries</span>
                      </div>
                    </div>
                  </TableCell>
                  <TableCell>
